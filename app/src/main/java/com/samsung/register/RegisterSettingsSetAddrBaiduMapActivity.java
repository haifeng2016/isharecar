...
import com.samsung.register.PoiAdapter.ViewHolder;

import java.util.List;

public class RegisterSettingsSetAddrBaiduMapActivity extends Activity implements BDLocationListener, OnGetGeoCoderResultListener, BaiduMap.OnMapStatusChangeListener, TextWatcher{

    private MapView mMapView;
    private BaiduMap mBaiduMap;
    private ListView poisLL;
    List<PoiInfo> poiInfos;
    private String TAG = "RegisterSettingsSetAddrBaiduMapActivity";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_registersettings_setaddr_baidumap);
        initView();
    }
    ...
    private void initView() {
        ...
        poisLL.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                PoiAdapter.ViewHolder viewHolder = (ViewHolder) view.getTag();
                if (viewHolder != null) {
                    Intent intent = new Intent();
                    intent.putExtra("name", viewHolder.getName());
                    intent.putExtra("address", viewHolder.getAddress());
                    Log.d("poisLL", "poisLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL");
    ...
    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult reverseGeoCodeResult) {
        if (reverseGeoCodeResult != null && reverseGeoCodeResult.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            // 只有当poiInfo不为空, 对于创建建议列表的adapter才有效
            if (poiInfos == null || poiInfos.size() == 0) {
                return;
            }
            PoiAdapter poiAdapter = new PoiAdapter(RegisterSettingsSetAddrBaiduMapActivity.this, poiInfos);
            if (poiAdapter != null) {
    ...
    public void afterTextChanged(Editable s) {
        Log.d(TAG, "searchAddress afterTextChanged");
            ...
            poiSearch.setOnGetPoiSearchResultListener(new OnGetPoiSearchResultListener() {
                ...
                public void onGetPoiResult(PoiResult poiResult) {
                    if (poiResult.error == SearchResult.ERRORNO.NO_ERROR) {
                        ...
                        PoiSearchAdapter poiSearchAdapter = new PoiSearchAdapter(RegisterSettingsSetAddrBaiduMapActivity.this, poiInfos, locationLatLng);
                        ...
                        searchPois.setOnItemClickListener(new OnItemClickListener(){
                            ...
                            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                PoiSearchAdapter.ViewHolder viewHolder = (PoiSearchAdapter.ViewHolder)view.getTag();
                                if(viewHolder != null){
                                    Intent intent = new Intent();
                                    intent.putExtra("name",viewHolder.getName());
                                    intent.putExtra("address", viewHolder.getAddress());
                                    Log.d("searchPois", "searchPoisLLLLLLLLLLLLLLLLLLL");
                                    setResult(RESULT_OK,intent);
                                    finish();
                                }
                            }
